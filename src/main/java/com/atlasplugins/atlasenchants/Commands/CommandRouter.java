    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (target == null) {
            ...
            for (String unknownCommand : main.getSettingsConfig().getStringList("Command-Messages.Command-Messages-UnknownCommand")) {
                String withPAPISet = main.isPlaceholderAPIPresent() ? PlaceholderAPI.setPlaceholders((Player) sender, unknownCommand) : unknownCommand;
        ...
        if (!(sender instanceof Player)) {
            ...
            for (String NotAPlayerMessage : main.getSettingsConfig().getStringList("Command-Messages.Command-Messages-NotAPlayer")) {
                String withPAPISet = main.isPlaceholderAPIPresent() ? PlaceholderAPI.setPlaceholders((OfflinePlayer) sender, NotAPlayerMessage) : NotAPlayerMessage;
                sender.sendMessage(Main.color(withPAPISet));
            }
            return true;
        }
